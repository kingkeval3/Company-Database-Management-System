...
<title>Resignation Reports</title>
<style>
body{
...
<body>
<h1><center>Resignation Reports </center></h1>
<table style="background-color:rgba(100, 100, 100, 0.5);">
<tr bgcolor="#FF6347">

<th>Employee ID</th>
<th>Employee Name</th>
<th>Resigning Purpose</th>
<th>Resigning Code</th>
...
PreparedStatement ps=con.prepareStatement("select * from resign");
