...
if( rid!=null && eid!=null && name!=null && rp!=null && rd!=null ){

if( rid!="" && eid!="" && name!="" && rp!=""&& rd!="" ) {

try {

connection = DriverManager.getConnection(connectionURL,"root","hhrpkpmcc");

String queryString = "insert into resign values( ?, ? , ? ,?, ?)";
...
pstatement.setString(3,rp);

pstatement.setString(4,rid);
pstatement.setString(5,rd);
...
<body background='suc3.jpg'>
        ...
        <center><h1 style='color:green'>Resignation Reported</h1><a href='staff.html'>BACK</a><center>
        </body>
